<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="是否已删除" prop="isDelete" width="120">
        ...
        <el-table-column align="left" label="按钮组">
            ...
            <el-button type="text" icon="edit" size="small" class="table-button" @click="updateAdFunc(scope.row)">变更</el-button>
