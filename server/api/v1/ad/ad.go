...
var adService = service.ServiceGroupApp.AdServiceGroup.AdService
...
// @Param data body ad.Ad true "创建Ad"
...
// @accept application/json
// @Produce application/json
// @Param data body ad.Ad true "删除Ad"
...
// @accept application/json
// @Produce application/json
// @Param data body ad.Ad true "更新Ad"
...
// @accept application/json
// @Produce application/json
// @Param data query ad.Ad true "用id查询Ad"
...
// @accept application/json
// @Produce application/json
// @Param data query adReq.AdSearch true "分页获取Ad列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /ad/getAdList [get]
func (adApi *AdApi) GetAdList(c *gin.Context) {
	var pageInfo adReq.AdSearch
...
// GetAdList 通过keyword获取Ad列表
// @Tags Ad
// @Summary 通过keyword获取Ad列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query adReq.AdSearch true "通过keyword获取Ad列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /ad/getAdList [get]
func (adApi *AdApi) GetAdListByKeyword(c *gin.Context) {
	if err, list := adService.GetAdInfoListByKeyword(c.Query("keyword")); err != nil {
		global.GVA_LOG.Error("获取失败!", zap.Error(err))
		response.FailWithMessage("获取失败", c)
	} else {
